          ...
          <div className="App container">
            <div className="card appointment-table">
              <div className="card-content">
                ...
                <Link className="button is-info" to="/form">
                  Create new Appointment
                </Link>
                <Link className="button is-danger" to="/" onClick={this.logout}>
                  Logout
                </Link>
              </div>
            </div>
        ...
        <div className="App container login-doink">
          <div className="card login-card">
            <Fade cascade>
              <div className="card-content">
                <h1 className="title">
                  Presenting my Appointment Booking app!
                </h1>
                <h2 className="subtitle">
                  Please login to proceed to the application, or sign up if you
